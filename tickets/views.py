...
from .serializers import MovisSerializers,ReservationSerializers,GuestSerializers
...
#########################################
#2 model data default djanog without res
...
class viewsets_movie(viewsets.ModelViewSet):
    ...
    serializer_class = MovisSerializers
...
def find_movie(request):
    ...
    try:
        ...
        serializer = MovisSerializers(movies, many= True)
    except Exception as e:
        return Response({"status": 404,"error": "Bad Request"},status=status.HTTP_404_NOT_FOUND)
